...
export const products: Product[] = [
  {
    ...
    brand: 'MuscleTech',
    image: muscletechMass,
    price: 12500,
    rating: 4.8,
    description: 'Advanced muscle building formula with 80g protein per serving'
  },
  {
    id: '2',
    ...
    price: 11900,
    rating: 4.7,
    description: 'High-calorie mass gainer with BCAAs and creatine'
  },
  {
    id: '3',
    name: 'Carnivor Mass',
    brand: 'MuscleMeds',
    image: musclemedsCarnivor,
    price: 13500,
    rating: 4.9,
    description: 'Beef protein isolate mass gainer for lean muscle'
  },
  {
    id: '4',
    name: 'Anabolic Mass',
    brand: 'Kevin Levrone',
    image: levroneAnabolic,
    price: 12000,
    rating: 4.6,
    description: 'Premium anabolic mass formula for extreme gains'
  },
  {
    id: '5',
    name: 'Gold Lean Mass',
    ...
    price: 14500,
    rating: 4.9,
    description: 'Gold standard lean mass gainer with minimal fat'
  },
  {
    id: '6',
    name: 'Critical Mass Professional',
    brand: 'Applied Nutrition',
    image: appliedCritical,
    price: 11500,
    rating: 4.5,
    description: 'Professional-grade mass gainer for serious athletes'
  },
  {
    id: '7',
    name: 'King Mass',
    ...
    price: 15000,
    rating: 5.0,
    description: 'King of mass gainers with 60g protein per serving'
  },
  {
    id: '8',
    ...
    price: 10500,
    rating: 4.4,
    description: 'Hard-hitting mass gainer for explosive growth'
  },
  {
    id: '9',
    name: 'Mass Infusion',
    ...
    price: 12200,
    rating: 4.7,
    description: 'Advanced mass infusion technology for rapid gains'
  },
  {
    id: '10',
    name: 'MASS Gainer',
    ...
    price: 10800,
    rating: 4.6,
    description: 'Champion formula mass gainer with optimal nutrition'
  }
]
...
export const HeroSection = ({ onProductClick }: HeroSectionProps) => {
  ...
  return (
    <section
      className='relative min-h-screen pt-24 pb-16 overflow-hidden bg-background'
    >
      {/* Background gradient */}
      <motion.div
      ...
      <div className='container mx-auto px-6'>
        ...
        >
          ...
          <motion.p
            ...
            transition={{ duration: 0.8 }}
          >
            Premium bodybuilding supplements crafted for champions. Experience
            unmatched quality with Ceylon Supplement&apos;s gold standard
            formulations.
          </motion.p>
          ...
          >
            ...
            >
              <Button
                size='lg'
                className='bg-gradient-to-r from-gold to-gold-light hover:from-gold-light hover:to-gold text-primary-foreground font-bold shadow-[var(--shadow-gold)] group'
            ...
            >
              <Button
                size='lg'
                variant='outline'
                className='border-2 border-gold text-foreground hover:bg-gold/10 font-semibold'
                onClick={() => document.getElementById('products')?.scrollIntoView({ behavior: 'smooth' })}
              >
                View Catalog
              </Button>
            ...
            >
              ...
              >
                <div className='flex items-center justify-center gap-2 mb-1'>
                  ...
                  <span className='text-2xl font-bold text-foreground'>
                    {statsInView ? (
                      <CountUp end={100} duration={1.6} suffix='%' redraw />
                    ) : (
                      '0%'
                    )}
                  </span>
              ...
              >
                <div className='flex items-center justify-center gap-2 mb-1'>
                  ...
                  <span className='text-2xl font-bold text-foreground'>
                    {statsInView ? (
                      <CountUp end={1} duration={1.4} redraw />
                    ) : (
                      '0'
                    )}
                  </span>
